...
if (isset($_POST['submit'])) {
    ...
    if (edit($condb, $_POST) > 0) {
        ...
        echo "
        <script>
            alert('Data pelajar gagal dikemas kini!');    
        </script>
        ";
    }
}
    ...
    <form action="" method="POST">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" name="nokp" id="nokp" required value="<?= 
                $nokp ?>">
            </li>
            <br>
            <li>
                <label for="ndp">NDP:</label><br>
                <input type="text" name="ndp" id="ndp" required value="<?= 
                $ndp ?>">
            </li>
            <br>
            <li>
            ...
            <li>
                ...
                <input type="text" name="kursus" id="kursus" required value="<?= 
                $kursus ?>">
            </li>
            <br>
            <li>
                <label for="gambar">Gambar:</label><br>
                <input type="text" name="gambar" id="gambar" required value="<?= 
                $gambar ?>">
            </li>
            <br>
